...
public abstract class MixinEntity implements ISpawnGroupObject {
    ...
    @Overwrite public boolean isCreatureType(EnumCreatureType type, boolean forSpawnCount) {
    ...
    @Override public void specifiedspawning$setSpawnType(EntityLiving.SpawnPlacementType cachedType) {
